...
export const Embed = (props: EmbedProps, children: DiscordEmbedField[]): DiscordEmbed => ({
	title: props.title,
	url: props.url,
	...
	fields: children.flat().filter(e => !!e).slice(0, 25),
	timestamp: props.timestamp ? Temporal.Instant.fromEpochMilliseconds(props.timestamp).toString() : undefined,
})

export const Field = (props: DiscordEmbedField): DiscordEmbedField => ({
	name: props.name,
	value: props.value,
